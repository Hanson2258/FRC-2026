...
1. <u>After building, it states it can't find lots of files or methods.</u> <br>
...
The Fuel interacts with both using a [custom Simulation](https://github.com/hammerheads5000/FuelSim) (similar to a 3D Physics engine) to simulate forces such as gravity, air-resistance, etc.
