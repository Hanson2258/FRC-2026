...
public class TunerConstants {
  ...
  private static final Slot0Configs driveGains =
      new Slot0Configs().withKP(0.2).withKI(0).withKD(0.01).withKS(0.5).withKV(0.124).withKA(0.2);
  ...
  private static final MomentOfInertia kSteerInertia =
      KilogramSquareMeters.of(0.004); // Changed to 0.004 for AdvantageKit
  private static final MomentOfInertia kDriveInertia =
      KilogramSquareMeters.of(0.025); // Changed to 0.025 for AdvantageKit
