  ...
  private void configureAutoBuilder() {
    ...
    try {
      ...
      DriverStation.reportError(
          "Failed to load PathPlanner config and configure AutoBuilder. PathPlanner features will be disabled. To enable, configure PathPlanner in the PathPlanner GUI.",
          ex.getStackTrace());
